...
Além das skills do ADK, você pode personalizar o comportamento central do agente editando o arquivo `langgraph_101.py`.
...
- **Localização**: `langgraph_101.py` (linhas 25-37 aproximadamente).
...
- **Localização**: `langgraph_101.py` (função `search_web`).
- **Como modificar**:
